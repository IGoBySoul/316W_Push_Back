...
motor leftMotorA = motor(PORT1, ratio6_1, true);   // Left front motor (reversed)
motor leftMotorB = motor(PORT2, ratio6_1, true);   // Left middle motor (reversed)
motor leftMotorC = motor(PORT3, ratio6_1, true);   // Left rear motor (reversed)
motor_group LeftDrive = motor_group(leftMotorA, leftMotorB, leftMotorC); // Left side group
motor rightMotorA = motor(PORT11, ratio6_1, false); // Right front motor
motor rightMotorB = motor(PORT12, ratio6_1, false); // Right middle motor
motor rightMotorC = motor(PORT13, ratio6_1, false); // Right rear motor
...
motor IntakeMotor1 = motor(PORT4, ratio6_1, false);    // Main intake roller
motor IntakeMotor2 = motor(PORT15, ratio18_1, false);   // Secondary intake (slower gear ratio)
motor IntakeMotor3 = motor(PORT14, ratio18_1, true);    // Chamber/roller (reversed)

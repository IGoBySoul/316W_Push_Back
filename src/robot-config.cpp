...
motor leftMotorB = motor(PORT11, ratio6_1, true);   // Left middle motor (reversed)
...
motor rightMotorA = motor(PORT2, ratio6_1, false); // Right front motor
motor rightMotorB = motor(PORT3, ratio6_1, false); // Right middle motor
motor rightMotorC = motor(PORT1, ratio6_1, false); // Right rear motor
...
drivetrain Drivetrain = drivetrain(LeftDrive, RightDrive, 10, 12, 3.25, inches, 0.75);
...
vex::digital_out lilWill(Brain.ThreeWirePort.C);
vex::digital_out alligner(Brain.ThreeWirePort.B);
vex::digital_out pusher(Brain.ThreeWirePort.A);
